...
<table>
  <tr>
    ...
    <td>
      <h3>Ostocare</h3>
      <strong>-Currently leading an industry-level mobile application project as the Head Developer, guiding my talented development team.<br>-This is a mobile application developed for the healthcare sector, with a primary focus on supporting Ostomy patients.
